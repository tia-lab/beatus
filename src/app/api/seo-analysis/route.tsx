import { recordToSlug, recordToWebsiteRoute } from '@/lib/records'
  ...
  try {
    ...
    if (!websitePath) {
      return invalidRequestResponse(
        `Dons't know which route corresponds to record #${itemId} (model: ${itemTypeApiKey})!`
      )
    }
    ...
    const response: SeoAnalysis = {
      locale: document.querySelector('html')?.getAttribute('lang') || 'de',
      slug: slug ?? 'unknown',
